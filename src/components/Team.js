...
function Team() {
  return (
    <div className="w-full max-xxl:w-[1440px] flex justify-center">
      <div className="mb-[180px] px-[52px] flex justify-center team-margin max-sm:px-0">
        <div className="grid grid-cols-4 gap-[16px] team-grid">
